...
print("******************************************************************************************")
print("*Este Script Añade el tamaño total de la carpeta a su nombre, Gracias (Market, 3RTVPaket)*")
print("******************************************************************************************")
pause()
...
print("******************************************************************************************")
print("*Gracias por usar el Software, Producido por 3RTVPaket                                   *")
print("*Prestamos Servicio de Creacion de Catalogos para Bancos de Audiovisuales                *")
print("*Tel-Whatsapp:+53 52472074                                                               *")
print("Servicio de Pakete Semanal 3RTVpaket: +53 43517275                                       *")
print("******************************************************************************************")
